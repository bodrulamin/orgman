package com.orgman.bodrul.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.orgman.bodrul.service.EmailAlreadyUsedException ||
            ex instanceof com.orgman.bodrul.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof com.orgman.bodrul.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.orgman.bodrul");
    }
}
